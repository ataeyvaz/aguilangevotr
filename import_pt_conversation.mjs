...
const insertPack = db.prepare(
  'INSERT INTO conversation_packs (word, difficulty, bot_language, level, context) VALUES (?, ?, ?, ?, ?)'
);

const insertExchange = db.prepare(
  'INSERT INTO conversation_exchanges (pack_id, exchange_order, bot_message, options, correct_index, points) VALUES (?, ?, ?, ?, ?, ?)'
);
